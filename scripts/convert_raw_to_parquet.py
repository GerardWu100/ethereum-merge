...
def main() -> None:
    ...
    quarterly_files = sorted(RAW_DATA_DIR.glob('DA-16_BTC_USDT_*_binance_quarterly.csv'))
    quarterly_files += sorted(RAW_DATA_DIR.glob('DA-16_ETH_USDT_*_binance_quarterly.csv'))
